...
//http://www.plinky.it/examples/openUI5/phonebook/proxy.php?url=https://spreadsheets.google.com/feeds/cells/0AsSW06f14AJYdEdsVjZLSklrMzdpbE0ycmNiQm4xMHc/od6/public/values%3falt=json
...
function initializeContact ( ) {
	...
	$contact['email'] 		= '';
	$contact['skype'] 		= '';
	$contact['skypeURL'] 	= 'http://www.skype.com';
	$contact['twitter'] 	= '';
	$contact['twitterURL'] 	= 'http://www.twitter.com';
	$contact['image'] 		= 'http://www.plinky.it/examples/openUI5/phonebook/img/man_default.jpeg';
	return $contact;
}
